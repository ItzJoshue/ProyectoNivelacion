...
class LoginFrame(ttk.Frame):
    ...
    def __init__(
        ...
        logo = tk.Canvas(marca, width=56, height=56, bg=Colors.BG_APP, highlightthickness=0)
        logo.pack()
        logo.create_oval(4, 4, 52, 52, fill=Colors.PRIMARY, outline="")
        logo.create_text(28, 28, text="U", fill=Colors.WHITE, font=(FONT, 20, "bold"))

        ttk.Label(centro, text="Sistema de nivelación uleam", style="Title.TLabel").pack(pady=(0, 4))
